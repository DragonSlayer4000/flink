...
import static org.apache.flink.table.catalog.hive.factories.HiveCatalogFactoryOptions.HIVE_CONF_PROPERTIES;
...
public class HiveCatalogFactory implements CatalogFactory {
    ...
    public Set<ConfigOption<?>> optionalOptions() {
        ...
        options.add(HIVE_CONF_PROPERTIES);
        return options;
    }
    ...
    public Catalog createCatalog(Context context) {
        ...
        return new HiveCatalog(
                ...
                helper.getOptions().get(HIVE_CONF_PROPERTIES));
    }
}
